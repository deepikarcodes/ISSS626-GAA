...
cat("RDS FILES SAVED:\n")
cat("- mpsz_analysis.rds\n")
cat("- busstop_analysis.rds\n") 
cat("- hexagon_grid.rds\n")
cat("- hexagon_trips_data.rds\n")
cat("- hexagon_trips_filtered.rds\n")
cat("- gi_hotspots_results.rds\n\n")

cat("SUBMISSION READY:\n")
cat("• Zip this entire project folder (including all .rds files and .qmd)\n")
cat("• Submit the zip file to your professor\n")
```
