...
## **3.a. A short note about GWmodel**
...
## **3.b. Geospatial Data Wrangling**

### **3.b.1. Importing geospatial data**
...
### **3.b..2 Updating CRS information**
...
## **3.c. Aspatial Data Wrangling**

### **3.c.1 Importing the aspatial data**
...
### **3.c.2 Converting aspatial data frame into a sf object**
...
### **3.d.2 Multiple Histogram Plots distribution of variables**
...
### **3.d.3 Drawing Statistical Point Map**
...
## **3.e. Hedonic Pricing Modelling in R**
...
### **3.e.1 Simple Linear Regression Method**
...
### **3.e.2. Multiple Linear Regression Method**

#### 3.e.2.1 Visualising the relationships of the independent variables
...
### **3.e.3. Building a hedonic pricing model using multiple linear regression method**
...
he output above reveals that all explanatory variables are statistically significant at 95% confident level.

### **3.e.5 Preparing Publication Quality Table: gtsummary method**
...
#### 3.e.6.1 Multicollinearity test
...
#### 3.e.6.2 Test for Non-Linearity
...
#### 3.e.6.3 Test for Normality Assumption
...
#### 3.e.6.4 Testing for Spatial Autocorrelation
...
## **3.f. Building Hedonic Pricing Models using GWmodel**
...
### **3.f.1 Building Fixed Bandwidth GWR Model**

\####**3.f.1.1. Computing fixed bandwith**
...
#### 3.f.1.2 GWModel method - fixed bandwith
...
### **3.f.2 Building Adaptive Bandwidth GWR Model**

In this section, we will calibrate the gwr-based hedonic pricing model by using adaptive bandwidth approach.

#### 3.f.2.1 Computing the adaptive bandwidth
...
#### 3.f.2.2 Constructing the adaptive bandwidth gwr model
...
### **3.f.4 Converting SDF into *sf* data.frame**
...
### **3.f.6 Visualising coefficient estimates**
