...
### 1.2a **Listings.csv from Aspatial folder**:

```{r}
listings <- read_csv("Data/Aspatial/listings.csv")
```

### 1.2b **MP14_Subzone shapefile from Geospatial folder**

```{r}
mpsz <- st_read(dsn="data/geospatial",layer ="MP14_SUBZONE_WEB_PL")
```

### 1.2c **Cyclingpath shapefile from Geospatial folder**

```{r}
cyclingpath <- st_read(dsn = "data/geospatial", layer = "CyclingPathGazette")
```

### 1.2d **PreSchoolLocation kml from Geospatial folder**
